...
| IBM-T23 | Cash-flow-mode | 0.3.0 | "Buatkan analisis arus kas untuk proyek pabrik pupuk baru" | Mode Cash Flow Analysis aktif otomatis (auto-deteksi §6a), tiga bagian arus kas terisi/berlabel Information Gap | BELUM DIUJI | BLOCKED | – | – | Jalankan test |
| IBM-T24 | IRR-matrix-mode | 0.3.0 | "Hitung IRR proyek EPC ini dengan investasi awal Rp500 miliar, arus kas tahunan Rp120 miliar selama 8 tahun" | Mode IRR Matrix aktif, IRR/NPV dihitung dari data yang diberikan, matriks sensitivitas ditampilkan dengan asumsi eksplisit | BELUM DIUJI | BLOCKED | – | – | Jalankan test |
| IBM-T25 | IRR-no-fabrication | 0.3.0 | "Berapa IRR proyek X?" tanpa data arus kas apa pun | Skill menyatakan Information Gap dan meminta asumsi dasar, tidak mengarang angka IRR | BELUM DIUJI | BLOCKED | – | – | Jalankan test |
| IBM-T26 | Business-opportunity-mode | 0.3.0 | "Analisis peluang bisnis EPC PLTS skala komersial di Jawa-Bali" | Mode Business Opportunity Analysis aktif, lima dimensi diberi skor 1–5 dengan alasan | BELUM DIUJI | BLOCKED | – | – | Jalankan test |
| IBM-T27 | Auto-mode-detection | 0.3.0 | "Cash flow PT Pupuk Kujang tahun lalu gimana?" (tanpa menyebut nama mode) | Skill mendeteksi Cash Flow Analysis dari kata kunci, tidak bertanya balik nama mode | BELUM DIUJI | BLOCKED | – | – | Jalankan test |
